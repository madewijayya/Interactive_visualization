...
end_year = st.slider("End Year", start_year, max_year, max_year)
...
start_year_corr = st.slider("Start Year (Correlation)", min_year, max_year, min_year)
end_year_corr = st.slider("End Year (Correlation)", start_year_corr, max_year, max_year)
