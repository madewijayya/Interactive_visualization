...
def update_plot_corr(attr, old, new):
    ...
    startSelain kesalahan `column` yang tidak didefinisikan, ada kesalahan pada baris ke-102 yang tidak lengkap. Anda perlu melanjutkan kode pada baris selanjutnya.

Berikut adalah kode yang telah diperbaiki sehingga dapat dijalankan pada Streamlit:
